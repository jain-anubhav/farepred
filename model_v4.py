"""
Flight price prediction model v4 - offer_date features.

New signal: offer_date = depdt - dfd
This is the calendar date a fare was observed. Fares from other flights
observed on the same offer_date in the same market capture contemporaneous
market-wide pricing conditions (seasonality, demand levels, etc.) that are
independent of how far any given flight is from departure.

At prediction time (dfd=40 for flight departing D):
  offer_date_obs = D - 40
  → look up all training fares in this market with offer_date == offer_date_obs
    to get a real-time market price level signal.
"""
import pandas as pd
import numpy as np
...
def main():
    ...
    # ===========================
    print("\n=== Model A: LightGBM (with offer_date features) ===")
    ...
    # ===========================
    print("\n=== Model B: LightGBM Residual (with offer_date features) ===")
    ...
    # Model C: XGBoost
    # ===========================
    print("\n=== Model C: XGBoost (with offer_date features) ===")
